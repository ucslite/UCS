...
FindOrders = function(){
	...
	*/
	...
	this.lockUnlockOrder = function(orderId, isLocked, takeOverLock){
		...
		var findOrdersForm = document.forms["customerServiceNavigationAction_AuthTokenInfo"];
		var authToken = findOrdersForm.customerServiceNavigationActions_authToken.value;
