...
wc.service.declare({
	...
	,successHandler: function(serviceResponse) {		
		...
		if (serviceResponse.ErrorCode != null){
			...
			alert('url'+url);
			window.location = "https://localhost/webapp/wcs/stores/servlet/RESTOrderCalculate?URL=http://localhost/webapp/wcs/stores/servlet/en/aurora?calculationUsageId=-1&calculationUsageId=-2&deleteCartCookie=true&page=&catalogId=10001&storeId=10203&globalLogIn=true";
		}			
	}
